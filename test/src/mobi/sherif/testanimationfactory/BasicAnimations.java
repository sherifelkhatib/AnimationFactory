...
import mobi.sherif.animation.textview.VibratingTextView;
...
public class BasicAnimations extends FragmentActivity implements AnimationFactory.SherifAnimationListener {
					...
					.setSingleChoiceItems(shush, 5,
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									case 5:
										animation = null;
										AnimationFactory.outHorizontal(sample, BasicAnimations.this);
										break;
									}
									;
